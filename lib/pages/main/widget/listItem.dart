...
import 'package:hacker_news/pages/detail/details_page.dart';
import 'package:hacker_news/utils/constant.dart';
import 'package:hacker_news/utils/screen_aware_size.dart';
import 'package:timeago/timeago.dart' as timeago;

listItem(snapshot, int index, context) {
  return InkWell(
    onTap: () {
      Navigator.of(context).push(MaterialPageRoute(
          builder: (context) => DetailsBlocProvider(
                child: DetailsPage(storyItem: snapshot[index]),
              )));
    },
    child: Container(
        color: Colors.white,
        ...
        child: ListTile(
          ...
          trailing: Column(
            children: <Widget>[
              ...
              Text('${snapshot[index].descendants}',
                  style: TextStyle(
